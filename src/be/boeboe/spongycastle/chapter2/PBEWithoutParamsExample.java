...
public class PBEWithoutParamsExample {
  ...
  public static void main(String[] args) throws Exception {
    ...
    Cipher cEnc = Cipher.getInstance("DESede/CBC/PKCS7Padding", "SC");
    ...
    SecretKeyFactory keyFact = SecretKeyFactory.getInstance("PBEWithSHAAnd3KeyTripleDES", "SC");
    Cipher cDec = Cipher.getInstance("PBEWithSHAAnd3KeyTripleDES", "SC");
