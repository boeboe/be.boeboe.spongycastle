package be.boeboe.spongycastle.chapter7;
 ...
 * Chapter 7 Utils
 */
public class Utils extends be.boeboe.spongycastle.chapter6.Utils {
  static {
  ...
  public static X509Certificate generateIntermediateCert(PublicKey intKey, PrivateKey caKey, X509Certificate caCert) throws Exception {
    ...
    return certGen.generateX509Certificate(caKey, "SC");
  }
